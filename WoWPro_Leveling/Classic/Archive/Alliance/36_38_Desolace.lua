TourGuide:RegisterGuide("JamDes3638", "Desolace", "Jame", "36", "38", "JamDus3840", "Alliance", function()
return [[
...
A Vahlarriel's Search|QID|1437|M|66.4,11.8|
A Down the Scarlet Path|QID|261|
A Reagents for Reclaimers Inc.|QID|1458|M|66.2,9.6|
A The Karnitol Shipwreck|QID|1454|M|66.2,9.6|
A Strange Alliance|QID|1382|
f Nijel's Point|QID|1437|N|Get the flight path.|M|64.65,10.55|
...
A Book of the Ancients|QID|6027|M|38.9,27.2|
T Claim Rackmore's Treasure!|N|Loot the chest at this location to complete the quest.|QID|6161|M|30.00,8.70|
C Book of the Ancients|N|Clear the area around the statue at this location.  Make sure your health is full, and click the statue until Lord Kragaru spawns.  Loot the book for the quest.|QID|6027|M|28.24,6.62|
C The Karnitol Shipwreck|N|Kill Slitherblade Sea Witches and Tidehunters until you get Karnitol's Satchel.|QID|1456|M|30.00,7.00|
T Book of the Ancients|QID|6027|M|38.9,27.2|
C Bone Collector|N|Get 10 Kodo Bones from the graveyard.  A Kodo Apparition may spawn each time you click a bone.|QID|5501|M|49.00,58.00|
A Kodo Roundup|QID|5561|M|60.9,61.9|
C Kodo Roundup|N|Use the Rod on any Aged, Ancient, or Dying Kodo, then run back to the goblin with it.  Do this five times to complete the quest.|QID|5561|M|55.8,62.9|
T Kodo Roundup|QID|5561|M|60.9,61.9|
C Strange Alliance|N|Kill Magrim Centaurs until you are friendly with the Gelkis faction.  Loot them for Centaur Ears.|QID|1382|M|70.00,70.00|
C Centaur Bounty|N|Get 15 Centaur Ears if you haven't already for the quest.|QID|1387|
