TourGuide:RegisterGuide("JamTho3132", "Thousand Needles", "Jame", "31", "32", "JamStr3235", "Alliance", function()
return [[
...
N Sell junk, repair, restock.|QID|1175|N|Sell junk, repair, restock.|
F Thalanaar|QID|1175|N|Fly to Thalanaar.|Z|Dustwallow Marsh|M|67.50,51.30|
R Thousand Needles|QID|1175|N|Go East to Thousand Needles.|
...
N From now on...|QID|1110|N|From now on, kill anything in the Mirage Raceway for quest progress.  Keep any Turtle Meat that you find (you need 10).  Do not kill anything that is too high of a level.|
N Turtle Meat|QID|555|N|Get 10 Turtle Meat.  You may also check the Auction House on another character and then mail yourself the meat, since the meat doesn't drop often.|L|3712 10|M|82.70,54.70|
...
N Saltstone Basilisks|QID|1175|N|Kill all the Saltstone Basilisks needed for the quest.  The Saltstone Basilisks can only be found in the northern side.  Kill other things and make progress on your other quests while doing this.|M|75.40,55.90|
C Rocket Car Parts|N|Get the rest of the Rocket Car Parts you need.  They are scattered everywhere.|QID|1110|M|75.4,55.0|
...
N Level 32|QID|1111|N|Grind if needed to reach level 32.|
R Tanaris|QID|1111|N|Run south to Tanaris.|
f Gadgetzan|QID|1111|N|Get the flight path.|Z|Tanaris|M|51.00,29.30|
F Theramore Isle|QID|1111|N|Fly to Theramore|
