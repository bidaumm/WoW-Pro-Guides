TourGuide:RegisterGuide("JamBad4142", "Badlands", "Jame", "41", "42", "JamStr4244", "Alliance", function()
return [[
R Ironforge|QID|707|
...
A Study of the Elements: Rock |QID|710|M|25.9,44.6|
...
C Study of the Elements: Rock |N|Go west of Lotwil and kill Lesser Elementals  until you get 10 Small Stone Shards.|QID|710|M|23.00,43.00|
T Study of the Elements: Rock |QID|710|M|25.9,44.6|
A Study of the Elements: Rock |QID|711|M|25.9,44.6|
A A Sign of Hope |N|Get the quest from the map on the ground at this location.|QID|720|M|53.00,34.00|
...
T A Sign of Hope |QID|720|M|53.6,43.3|
...
C Study of the Elements: Rock |N|Kill Rock Elementals until you get 3 Large Stone Slabs for this quest.|QID|711|M|39.00,74.00|
...
T Study of the Elements: Rock |QID|711|M|25.9,44.6|
A Study of the Elements: Rock |QID|712|M|25.9,44.6|
...
C Study of the Elements: Rock |N|Kill Greater Rock Elementals here until you get the Bracers of Rock Binding for this quest.  There are more Elementals west of this location.|QID|712|M|17.00,83.00|
...
T This Is Going to Be Hard |QID|734|M|25.9,44.6|
A This Is Going to Be Hard |QID|777|M|25.9,44.6|
T This Is Going to Be Hard |QID|777|M|25.9,44.6|
...
A This Is Going to Be Hard |QID|778|M|25.9,44.6|
C This Is Going to Be Hard |N|Kill the Elemental and loot the shackles.|QID|778|
T This Is Going to Be Hard |QID|778|M|25.9,44.6|
...
A Mazen's Behest |QID|1363|
T Mazen's Behest |QID|1363|
A Mazen's Behest |QID|1364|
